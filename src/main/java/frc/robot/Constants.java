...
/*Notes: 
 * Given forward joystick: 
 * Mod 0 (FL): negative velocity, rotating forward
 * Mod 1 (FR): negative velocity, rotating backward
 * Mod 2 (BL): positive velocity, rotating forward (CORRECT)
 * Mod 3 (BR): negative velocity, rotating backward
 */
